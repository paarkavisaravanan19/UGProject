...
const char *ssid = "Paarkavi";  //ENTER YOUR WIFI SETTINGS
const char *password = "paarkavi#1905";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.43.117/biometricattendance/getdata.php"; //computer IP or the server domain
int FingerID = 0;     // The Fingerprint ID from the scanner 
uint8_t id;
int Status = 2;  // Digital pin D7 ==> should go to relay

int sensor = 15;  // Digital pin D8 <== should come from sensor
//*************************Biometric Icons*********************************
